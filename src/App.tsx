...
>
  <div className="relative"> 
    ...
    > 
      ...
      {/* Contact Section */}
      <div className="relative h-screen w-full bg-black flex items-center justify-center text-center overflow-hidden">
  {/* Background Texture */}
  <div className="absolute inset-0 opacity-[0.5] bg-[url('/path-to-your-background.jpg')] bg-cover bg-center z-0" />

  {/* Content */}
  <div className="z-10 text-white flex flex-col items-center px-4">
    <h1 className="text-5xl md:text-6xl font-extrabold tracking-tight uppercase">
      LET'S START A CONVERSATION
    </h1>
    <p className="mt-4 text-xl md:text-2xl text-gray-400 font-medium">
    ...
    <div className="mt-8 text-center">
      <div className="flex flex-col items-center">
        ...
        <a
          ...
          className="text-cyan-400 font-bold text-lg hover:underline"
        >
          SANIMANI @ GMAIL.COM
        </a>
        <p className="text-gray-400 mt-1 text-sm">Let’s create something that actually works.</p>
      </div>
    </div>
    ...
    <div className="mt-8">
      <div className="flex flex-col items-center">
        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mb-2" viewBox="0 0 24 24" fill="currentColor">
          <path d="M4.98 3.5C4.98 4.88 3.88 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1 4.98 2.12 4.98 3.5zM0 8h5v16H0V8zm7.5 0h4.8v2.3h.1c.67-1.27 2.3-2.6 4.7-2.6 5 0 5.9 3.3 5.9 7.6V24h-5v-7.3c0-1.8-.03-4.1-2.5-4.1-2.5 0-2.9 1.9-2.9 3.9V24h-5V8z" />
        </svg>
        <a
    ...
    <div className="mt-8">
      <div className="flex flex-col items-center">
        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path d="M7 2C4.79 2 3 3.79 3 6v12c0 2.21 1.79 4 4 4h10c2.21 0 4-1.79 4-4V6c0-2.21-1.79-4-4-4H7zm5 5a5 5 0 110 10 5 5 0 010-10zm6.5-1.5a1.5 1.5 0 110 3 1.5 1.5 0 010-3zM12 9a3 3 0 100 6 3 3 0 000-6z" fill="currentColor" />
        </svg>
        <a
