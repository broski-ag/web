...
<div
  id="contact-section"
  className="relative h-screen w-full z-10 overflow-hidden flex items-center justify-center translate-y-[-40px]"
>
  {/* Main Content */}
  <div className="relative z-20 text-center max-w-4xl mx-auto px-6 shadow-2xl rounded-2xl bg-black/60 backdrop-blur-md">
    {/* Main Heading */}
    <div className="mb-12">
